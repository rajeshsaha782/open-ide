...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.run = function () {
        ...
        this._apiService.getSubmissionsToken(this.code.replace('"', '\"'))
            ...
            var submissionsToken = data['token'];
            console.log("token:  " + submissionsToken);
            _this.getResult(submissionsToken);
        }, function (error) {
            console.log(error);
        });
    };
    AppComponent.prototype.getResult = function (token) {
        var _this = this;
        this._apiService.getResultBySubmissionsToken(token)
            ...
            _this.result = data['stdout'];
            _this.error = data['stderr'];
        }, function (error) {
            console.log(error);
        });
    };
    AppComponent.prototype.changeCodemirrorMode = function (mode_name) {
        this.options = {
            lineNumbers: true,
            theme: 'twilight',
            // lineWrapping : true,
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _ctrl_ngx_codemirror__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ctrl/ngx-codemirror */ "./node_modules/@ctrl/ngx-codemirror/fesm5/ctrl-ngx-codemirror.js");
...
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        this.http = http;
        this.API_URL = "https://api.judge0.com";
        this.SubmissionsTokenRoute = "/submissions?base64_encoded=false";
        this.resultRoute = "/submissions/<token>?base64_encoded=false";
    }
    ApiService.prototype.getSubmissionsToken = function (code) {
        console.log(code);
        var body = { "language_id": "34", "source_code": code, "stdin": "" };
        var myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.post(this.API_URL + this.SubmissionsTokenRoute, JSON.stringify(body), { headers: myheader });
    };
    ApiService.prototype.getResultBySubmissionsToken = function (token) {
        var route = this.resultRoute.replace('<token>', token);
...
module.exports = __webpack_require__(/*! E:\Projects\open-ide\src\main.ts */"./src/main.ts");
